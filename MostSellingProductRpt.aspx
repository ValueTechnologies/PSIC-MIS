<%@ Page Title="" EnableEventValidation="false" Language="C#" MasterPageFile="~/MasterPageD.master" AutoEventWireup="true" CodeBehind="MostSellingProductRpt.aspx.cs" Inherits="PSIC.MostSellingProductRpt" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('.heading h3').html('Most Selling Product');
            ...
            <div class="box">
                ...
                <div class="content" id="dvSearch">
                    ...
                    <form class="form-horizontal" action="#">
                        ...
                        <div class="form-row row-fluid">
                            <div class="span6">
                                <label class="form-label span4" style="margin-top: 9px;" for="normal">Report Type : </label>
                                <div class="span8 controls sel" style="margin-left: 0px;">
                                    <asp:DropDownList ID="ddlReportType" runat="server" class="nostyle">
                                        <asp:ListItem Value="Amount">Amount Wise</asp:ListItem>
                                        <asp:ListItem Value="Qty">Qty Wise</asp:ListItem>
                                    </asp:DropDownList>
                                </div>
