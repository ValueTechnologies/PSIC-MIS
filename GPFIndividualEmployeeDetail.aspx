<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageD.master" AutoEventWireup="true" CodeBehind="GPFIndividualEmployeeDetail.aspx.cs" Inherits="PSIC.GPFIndividualEmployeeDetail" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    &nbsp;
    <script type="text/javascript">
        $(document).ready(function () {
            $('.heading h3').html('GPF Individual Employees Detail');
            ...
            $('#btnSearch').bind('click', function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $.each(jData, function (i, item) {
                            out = out + '<tr><td> ' + item.sno + '</td> <td> ' + item.EmpNo + '</td>  <td> ' + item.Full_Name + '</td>  <td> ' + item.FatherName + '</td> <td> ' + item.CNIC + '</td> <td> ' + item.DepartmentName + '</td> <td> ' + item.Designation + '</td>  <td> <a href="GPFIndividualEmployeeRpt.aspx?ID=' + item.User_ID + '" target="_blank"   >Detail Report</a></td></tr>';
                        });
