<%@ Page Title="" EnableEventValidation="false" Language="C#" MasterPageFile="~/MasterPageD.master" AutoEventWireup="true" CodeBehind="IncomeStatement.aspx.cs" Inherits="PSIC.IncomeStatement" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    &nbsp;
        ...
        $(document).ready(function () {
            $('.heading h3').html('Income Statement');
