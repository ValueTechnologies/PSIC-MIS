<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageD.master" AutoEventWireup="true" CodeBehind="PensionEmployeeWiseReport.aspx.cs" Inherits="PSIC.PensionEmployeeWiseReport" %>
            ...
            $('#btnSearch').bind('click', function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $.each(jData, function (i, item) {
                            out = out + '<tr><td> ' + item.sno + '</td> <td> ' + item.EmpNo + '</td>  <td> ' + item.Full_Name + '</td>  <td> ' + item.FatherName + '</td> <td> ' + item.CNIC + '</td> <td> ' + item.DepartmentName + '</td> <td> ' + item.Designation + '</td> <td> <a href="PensionEmployeeWiseYearlyRpt.aspx?ID=' + item.User_ID + '" target="_blank">Report </a></td> </tr>';
                        });
