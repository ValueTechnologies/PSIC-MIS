...
namespace PSIC
{
    public partial class PromotionHistoryRpt : System.Web.UI.Page
    {
        ...
        private void ShowReport(string ID)
        {
            try
            {
                ...
                DSHR ds = new DSHR();
                string reportPath = Server.MapPath("PromotionHistoryRpt.rdlc");
                DSHRTableAdapters.usp_EmployeeBasicInfoByIDTableAdapter da1 = new DSHRTableAdapters.usp_EmployeeBasicInfoByIDTableAdapter();
                DSHRTableAdapters.usp_PromotionHistoryRptTableAdapter da2 = new DSHRTableAdapters.usp_PromotionHistoryRptTableAdapter();

                da1.Fill(ds.usp_EmployeeBasicInfoByID, Convert.ToInt32(ID));
                da2.Fill(ds.usp_PromotionHistoryRpt, Convert.ToInt32(ID));
                ...
                ReportViewer1.LocalReport.DataSources.Add(new Microsoft.Reporting.WebForms.ReportDataSource("DataSet2", ds.Tables["usp_PromotionHistoryRpt"]));
