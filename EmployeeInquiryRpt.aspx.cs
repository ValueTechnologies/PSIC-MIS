...
namespace PSIC
{
    public partial class EmployeeInquiryRpt : System.Web.UI.Page
    {
        ...
        private void ShowReport(string ID)
        {
            try
            {
                ...
                DSHR ds = new DSHR();
                string reportPath = Server.MapPath("EmployeeInquiryRpt.rdlc");
                DSHRTableAdapters.usp_EmployeeBasicInfoByIDTableAdapter da1 = new DSHRTableAdapters.usp_EmployeeBasicInfoByIDTableAdapter();
                DSHRTableAdapters.usp_EmployeeInquiryRptTableAdapter da2 = new DSHRTableAdapters.usp_EmployeeInquiryRptTableAdapter();

                da1.Fill(ds.usp_EmployeeBasicInfoByID, Convert.ToInt32(ID));
                da2.Fill(ds.usp_EmployeeInquiryRpt, Convert.ToInt32(ID));
                ...
                ReportViewer1.LocalReport.DataSources.Add(new Microsoft.Reporting.WebForms.ReportDataSource("DataSet2", ds.Tables["usp_EmployeeInquiryRpt"]));
