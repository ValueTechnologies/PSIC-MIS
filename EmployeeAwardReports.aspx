<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageD.master" AutoEventWireup="true" CodeBehind="EmployeeAwardReports.aspx.cs" Inherits="PSIC.EmployeeAwardReports" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $('.heading h3').html('Employee Award List');

            $(function () {
                $("#txtAwardDate").datepicker({ dateFormat: 'dd - MM - yy', changeYear: true, changeMonth: true });
            });
            ...
            $('#btnSave').bind('click', function () {
                if ($('#txtAwardDate').val().trim() == "") {
                    alert('Please select Date of award');
                    return;
                }

                if ($('#txtAwardReason').val().trim() == "") {
                ...
                $.ajax({
                    ...
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    url: "EmployeeAwardReports.aspx/SaveAward",
                    data: "{ 'date' : '" + $('#txtAwardDate').val().trim() + "', 'reason' : '" + $('#txtAwardReason').val().trim() + "', 'remarks' : '" + $('#txtRemarks').val().trim() + "', 'empid' : '"+ $('#btnSave').attr('tag') +"'}",
                    success: function (response) {
            ...
            <div class="box">
                ...
                <div class="content">
                    ...
                    <form class="form-horizontal" action="#">
                        ...
                        <div class="form-row row-fluid">
                            <div class="span12">
                                <label class="form-label span3" for="normal">Award Date</label>
                                <input id="txtAwardDate" type="text" class="txtcs  span4" />
                            </div>
                        </div>
                        ...
                        <div class="form-row row-fluid">
                            <div class="span12">
                                ...
                                <input id="txtAwardReason" type="text" class="txtcs  span4" />
                            </div>
                        </div>
                        ...
                        <div class="form-row row-fluid">
                            <div class="span12">
                                ...
                                <textarea id="txtRemarks" cols="20" rows="2" class="span4"></textarea>
