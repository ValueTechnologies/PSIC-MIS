<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageD.master" AutoEventWireup="true" CodeBehind="TraningReports.aspx.cs" Inherits="PSIC.TraningReports" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    &nbsp;
    <script type="text/javascript">
        $(document).ready(function () {
            $('.heading h3').html('Training Report');


            $(function () {
                $("#txtTraninigDateFrom").datepicker({ dateFormat: 'dd - MM - yy', changeYear: true, changeMonth: true });
            });


            $(function () {
                $("#txtTraninigDateTo").datepicker({ dateFormat: 'dd - MM - yy', changeYear: true, changeMonth: true });
            });
            ...
            $('#btnSave').bind('click', function () {
                ...
                if ($('#txtTraningInstituteName').val() == "") {
                    alert('Please enter institute Name...');
                    return;
                }

                if ($('#txtTraningName').val() == "") {
                    alert('Please enter Traning Name...');
                    return;
                }



                if ($('#txtTraninigDateFrom').val() == "") {
                    alert('Please enter Training Starting Date...');
                    return;
                }


                if ($('#txtTraninigDateTo').val() == "") {
                    alert('Please enter Traning Ending Date...');
                    return;
                }
                ...
                $.ajax({
                    ...
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    url: "TraningReports.aspx/SaveData",
                    data: "{ 'TraningName' : '" + $('#txtTraningName').val() + "', 'InstituteName' : '" + $('#txtTraningInstituteName').val() + "', 'StartingDate' : '" + $('#txtTraninigDateFrom').val() + "', 'EndingDate' : '" + $('#txtTraninigDateTo').val() + "', 'EmpID' : '" + $('#btnSave').attr('tag') + "'}",
                    success: function (response) {
                        alert('Save Successfully!');
                        $('#txtTraningInstituteName').val('');
                        $('#txtTraningName').val('');
                        $('#txtTraninigDateFrom').val('');
                        $('#txtTraninigDateTo').val('');
    ...
    <div class="row-fluid">
        <div class="span12">
            <div class="box">
                <div class="title">
                    <h4>
                        <span>Employee Tranning Info.</span>
                    </h4>
                </div>
                <div class="content">
                    ...
                    <form class="form-horizontal" action="#">
                        ...
                        <div class="form-row row-fluid">
                            <div class="span12">
                                ...
                                <input id="txtTraningInstituteName" type="text" class="txtcs  span4" />
                        ...
                        <div class="form-row row-fluid">
                            <div class="span12">
                                <label class="form-label span3" for="normal">Traning Name</label>
                                <input id="txtTraningName" type="text" class="txtcs  span4" />
                            </div>
                        </div>
                        ...
                        <div class="form-row row-fluid">
                            <div class="span12">
                                <label class="form-label span3" for="normal">Traning Start (From)</label>
                                <input id="txtTraninigDateFrom" type="text" class="txtcs  span4" />
                            </div>
                        </div>

                         <div class="form-row row-fluid">
                            <div class="span12">
                                <label class="form-label span3" for="normal">Traning End (To)</label>
                                <input id="txtTraninigDateTo" type="text" class="txtcs  span4" />
                            </div>
                        </div>
