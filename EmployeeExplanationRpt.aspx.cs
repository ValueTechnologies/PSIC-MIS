...
namespace PSIC
{
    public partial class EmployeeExplanationRpt : System.Web.UI.Page
    {
        ...
        private void ShowReport(string ID)
        {
            try
            {
                ...
                DSHR ds = new DSHR();
                string reportPath = Server.MapPath("EmployeeExplanationRpt.rdlc");
                DSHRTableAdapters.usp_EmployeeBasicInfoByIDTableAdapter da1 = new DSHRTableAdapters.usp_EmployeeBasicInfoByIDTableAdapter();
                DSHRTableAdapters.usp_EmployeeExpalantionRptTableAdapter da2 = new DSHRTableAdapters.usp_EmployeeExpalantionRptTableAdapter();

                da1.Fill(ds.usp_EmployeeBasicInfoByID, Convert.ToInt32(ID));
                da2.Fill(ds.usp_EmployeeExpalantionRpt, Convert.ToInt32(ID));
                ...
                ReportViewer1.LocalReport.DataSources.Add(new Microsoft.Reporting.WebForms.ReportDataSource("DataSet2", ds.Tables["usp_EmployeeExpalantionRpt"]));
