...
//function alert(n) {
//    $("<div title='PSIC - (M&ES)'><div class='msgbox'>" + n + "<\/div><\/div>").dialog({
//        modal: !0,
//        show: {
//            effect: "drop",
//            duration: 500,
...
function alert(n) {
    $('<div class="modal hide fade"  style="display:none;"><div class="modal-header"><button type="button" class="close" data-dismiss="modal"><span class="icon12 minia-icon-close"></span></button><h3>PSIC - (MIS)</h3></div><div class="modal-body"><div class="paddingT15 paddingB15">' + n + '</div></div><div class="modal-footer"><a href="#" class="btn" data-dismiss="modal">Close</a></div></div>').modal('toggle');
}
...
$(document).ready(function() { 	
	...
	$("input, textarea, select").not('.nostyle').uniform();//Hasssan change
